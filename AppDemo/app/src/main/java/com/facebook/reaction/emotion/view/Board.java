...
public class Board {
    ...
    /*DIVIDE = 5dp, Emotion.NORMAL_SIZE = 40dp*/
    public static final int BOARD_WIDTH = 6 * Emotion.NORMAL_SIZE + 7 * CommonDimen.DIVIDE;
    ...
    public static final float BOARD_BOTTOM = CommonDimen.HEIGHT_VIEW_REACTION;
